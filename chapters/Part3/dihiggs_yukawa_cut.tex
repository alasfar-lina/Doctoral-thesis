...
When the fit is performed on this signal strength with charm mistagging probability, we obtain the upper projected limit on the charm final state signal strength after profiling over~$\mu_b$,
\begin{equation}
